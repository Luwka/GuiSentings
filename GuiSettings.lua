...
--Create Window
local Win = Lib:CreateWindow("LCheat", Tab ,0.77,nil)
...
local Speed = PlayerT:CreateSlider("WalkSpeed",0,500,22,function(S)
game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = S
print("WalkSpeed"..S)
	end)

local Jump = PlayerT:CreateSlider("JumpPower",0,300,50,function(J)
game.Players.LocalPlayer.Character.Humanoid.JumpPower = J
print("JumpPower"..J)
	end)

PlayerT:CreateSlider("Gravity",0,500,200, function(G)
		workspace.Gravity = G
end)

PlayerT:CreateButton("Default",function()
game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 19
game.Players.LocalPlayer.Character.Humanoid.JumpPower = 50
workspace.Gravity = 200
print("Speed and Jump defaults")
end)

PlayerT:CreateButton("fly",function()
...
PlayerT:CreateToggle("AutoFatm ",false,function(t)
getgenv().autoFarm = t
...
VisualT:CreateButton("Console",function()	game:GetService("StarterGui"):SetCore("DevConsoleVisible",true)
	end)

VisualT:CreateButton("Keyboard",function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/advxzivhsjjdhxhsidifvsh/mobkeyboard/main/main.txt", true))()
	end)


VisualT:CreateButton("Auto Builder",function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/max2007killer/auto-build-not-limit/main/autobuild.txt"))()
	end)

VisualT:CreateButton("Esp",function()
while wait(0.5) do for i, childrik in ipairs(workspace:GetDescendants()) do if childrik:FindFirstChild("Humanoid") then if not childrik:FindFirstChild("EspBox") then if childrik ~= game.Players.LocalPlayer.Character then local esp = Instance.new("BoxHandleAdornment",childrik) esp.Adornee = childrik esp.ZIndex = 0 esp.Size = Vector3.new(4, 5, 1) esp.Transparency = 0.65 esp.Color3 = Color3.fromRGB(255,48,48) esp.AlwaysOnTop = true esp.Name = "EspBox" end end end end end
end)
